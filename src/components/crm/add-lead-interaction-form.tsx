...
import { addLeadInteractionAction, type ActionState } from "@/lib/actions/crm";

const initialState: ActionState = {};

export function AddLeadInteractionForm({ leadId }: { leadId: string }) {
  const [open, setOpen] = useState(false);
  const [state, formAction, pending] = useActionState(addLeadInteractionAction, initialState);
