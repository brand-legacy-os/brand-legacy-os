...
import { createReceivableAction, type ActionState } from "@/lib/actions/finance";
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <input name="cliente" required placeholder="Cliente" className="h-9 rounded-(--radius-s) border border-border bg-canvas px-3 text-[13px] outline-none" />
        <input name="empresa" placeholder="Empresa (opcional)" className="h-9 rounded-(--radius-s) border border-border bg-canvas px-3 text-[13px] outline-none" />
        <input name="produto" placeholder="Produto" className="h-9 rounded-(--radius-s) border border-border bg-canvas px-3 text-[13px] outline-none" />
        ...
        <input name="valor" inputMode="decimal" required placeholder="Valor (R$)" className="h-9 rounded-(--radius-s) border border-border bg-canvas px-3 text-[13px] outline-none" />
