...
export default async function SocialIntroducaoPage() {
    ...
    <>
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="max-w-[62ch] text-[13px] text-ink-soft">
          Perfis geridos pelo time, recursos e ferramentas de apoio.
        </p>
      </div>
